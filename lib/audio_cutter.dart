...
class AudioCutter {
  /// Return audio file path after cutting and removing background noise
  static Future<String> cutAudio(
    ...
    var cmd = "-y -i \"$path\" -vn -ss $start -to $end -ar 16k -ac 2 -b:a 96k -acodec pcm_s16le -af afftdn=nr=70 -c:v copy $outPath";
