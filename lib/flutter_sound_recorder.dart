...
//
// import 'const/toastMessage.dart';
//
...
//               numChannels: 1,
//               sampleRate:
//               (_codec == Codec.pcm16 && _media == Media.asset)
//                   ? 48000
//                   : tSAMPLERATE,
//             );
...
//           value: tSAMPLERATE,
//           // Step 4.
//           items: <int>[1000, 8000, 11025, 16000,22025,24000,32000,44100]
...
//           value: bitRates,
//           // Step 4.
//           items: <int>[8000, 16000, 24000, 32000]
//               .map<DropdownMenuItem<int>>((int value) {
//             return DropdownMenuItem<int>(
//               value: value,
//               child: Text(
